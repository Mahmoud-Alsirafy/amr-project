...
<body>
    ...
    <main>
        <div class="content-box lesson-section" id="preTest">
            ...
            <form id="preTestForm">
                <div class="question">
                    <p>1. What does "mother" mean?</p>
                    <div class="options">
                        <label><input type="radio" name="q1" value="a" required> أب</label>
                        <label><input type="radio" name="q1" value="b"> أم</label>
                        <label><input type="radio" name="q1" value="c"> أخ</label>
                    </div>
                </div>
                <button type="button" class="btn" onclick="showLesson()">Start Lesson</button>
            </form>
        </div>

        <div class="content-box lesson-section" id="lessonContent" style="display:none;">
            <h2>Lesson: My Family</h2>
            <div class="lesson-content">
                <p>In this lesson, you will learn the names of family members:
                    Father - أب, Mother - أم, Brother - أخ, Sister - أخت.</p>
            </div>
            <button type="button" class="btn" onclick="showPostTest()">Post-test</button>
        </div>
        ...
        <div class="content-box lesson-section" id="postTest" style="display:none;">
            ...
            <form id="postTestForm">
                <div class="question">
                    <p>1. What does "sister" mean?</p>
                    <div class="options">
                        <label><input type="radio" name="post_q1" value="a" required> أم</label>
                        <label><input type="radio" name="post_q1" value="b"> أخت</label>
                        <label><input type="radio" name="post_q1" value="c"> جد</label>
                    </div>
                </div>
                <button type="button" class="btn" onclick="finishLesson()">Finish Lesson</button>
            </form>
        </div>
        <div class="video-container text-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/zNLRiB-qOAs?si=zr-Zgct31aRBs0Xo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>            </div>
    </main>
